    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">
          Good Morning! <span className="text-blue-600">Aahsham Iqbal</span>
        </h1>
      </div>
          ...
          <Table>
            ...
            <TableBody>
              {patientsData.map((patient, index) => (
                <TableRow key={index}>
                  <TableCell className="font-medium">{patient.admitted}</TableCell>
                  <TableCell>{patient.case}</TableCell>
                  <TableCell>
                    <Badge className={getStatusColor(patient.status)}>{patient.status}</Badge>
                  </TableCell>
                  <TableCell>
                    <Badge className={getDocumentColor(patient.documents)}>{patient.documents}</Badge>
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
