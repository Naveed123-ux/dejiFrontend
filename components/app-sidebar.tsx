...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="bg-blue-500 border-r-0">
      <SidebarContent className="bg-blue-500 justify-center border-r-0">
        <SidebarGroup className="pt-8 ">
          <SidebarGroupContent className="">
            <SidebarMenu className="space-y-2 ">
              {menuItems.map((item) => (
                <SidebarMenuItem key={item.title} className="inline-flex ">
                  <SidebarMenuButton
                    ...
                    className="text-white hover:bg-blue-400 data-[active=true]:bg-blue-600 data-[active=true]:text-white h-13 text-sm px-2 inline-flex items-center"
                  >
                    <Link
                      href={item.url}
              ...
              <SidebarMenuItem>
                <SidebarMenuButton className="text-white hover:bg-blue-400 h-12 text-sm justify-center px-4">
